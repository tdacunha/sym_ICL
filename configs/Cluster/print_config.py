...
data_product_dir = "/sdf/group/kipac/g/cosmo/ki21/phil1/simulations/ZoomIns/Cluster/%s/"
...
for i in range(len(haloes)):
    ...
    snapshot_format = "%s/%s/output_HR/snapshot%%03d.%%d" % (p_dir, h)
